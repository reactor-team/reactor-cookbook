    ...
    def apply_action(
        ...
        *,
        ...
        Args:
            ...
            clip_outliers: Override the processor's clipping policy for this
                call. RTC prefixes use ``False`` because decoded actions must
                round-trip back into normalized space without being changed.
